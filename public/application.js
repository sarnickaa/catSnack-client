...
var userLogin = function userLogin(event) {
  ...
  api.login(data).then(ui.onLoginSuccess).catch(ui.loginError);
  $("#log-in-form")[0].reset();
};

var userRegister = function userRegister(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.register(data).then(ui.onRegisterSuccess).catch(ui.registerError);
  $("#register-form")[0].reset();
};

var userPwChange = function userPwChange(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.pwChange(data).then(ui.onPwSuccess).catch(ui.pwError);
  $("#change-pw-form")[0].reset();
};

var userLogout = function userLogout(event) {
  event.preventDefault();
  api.logout().then(ui.onLogoutSuccess).catch(ui.logoutError);
};

var createPet = function createPet(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.createNewPet(data).then(ui.onCreatePetSuccess).catch(ui.createPetError);
  $("#create-pet")[0].reset();
};

var seeUserPets = function seeUserPets(event) {
  event.preventDefault();
  api.getUserPets().then(ui.onGetPetSuccess).catch(ui.getPetError);
};

var seeOnePet = function seeOnePet(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.getOnePet(data).then(ui.onGetOnePetSuccess).catch(ui.getOnePetError);
  $("#see-one-pet")[0].reset();
};

var deletePet = function deletePet(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.deleteOnePet(data).then(ui.onDeletePetSuccess).catch(ui.deletePetError);
  $("#delete-pet")[0].reset();
};

var updatePet = function updatePet(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.updateOnePet(data).then(ui.onUpdateSuccess).catch(ui.updateError);
  $("#update-pet")[0].reset();
};
...
var createFood = function createFood(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.createNewFood(data).then(ui.onCreateFoodSuccess).catch(ui.createFoodError);
  $("#create-food")[0].reset();
};

var seeUserFoods = function seeUserFoods(event) {
  event.preventDefault();
  api.getUserFoods().then(ui.onGetFoodsSuccess).catch(ui.getFoodsError);
};

var seeOneFood = function seeOneFood(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.getOneFood(data).then(ui.onGetOneFoodSuccess).catch(ui.getOneFoodError);
...
var deleteFood = function deleteFood(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.deleteOneFood(data).then(ui.onDeleteFoodSuccess).catch(ui.deleteFoodError);
  $("#delete-food")[0].reset();
};
...
var updateFood = function updateFood(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.updateOneFood(data).then(ui.onUpdateFoodSuccess).catch(ui.updateFoodError);
  $("#update-food")[0].reset();
};

var seeShelters = function seeShelters(event) {
  event.preventDefault();
  var data = getFormFields(this);
  console.log(data);
  api.myShelters(data).then(ui.onShelterSuccess).catch(ui.ShelterError);
  $("#shelters")[0].reset();
};
...
module.exports = {
  ...
  createPet: createPet,
  seeUserPets: seeUserPets,
  seeOnePet: seeOnePet,
  deletePet: deletePet,
  updatePet: updatePet,
  createFood: createFood,
  seeUserFoods: seeUserFoods,
  seeOneFood: seeOneFood,
  deleteFood: deleteFood,
  updateFood: updateFood,
  seeShelters: seeShelters
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var pwChange = function pwChange(data) {
  return $.ajax({
...
var createNewPet = function createNewPet(data) {
  return $.ajax({
...
var getUserPets = function getUserPets() {
  return $.ajax({
    url: config.apiUrl + '/pets',
    method: 'GET',
    headers: {
...
var getOnePet = function getOnePet(data) {
  return $.ajax({
...
var deleteOnePet = function deleteOnePet(data) {
  return $.ajax({
    url: config.apiUrl + '/pets/' + data.id,
    method: 'DELETE',
    headers: {
...
var updateOnePet = function updateOnePet(data) {
  return $.ajax({
    url: config.apiUrl + '/pets/' + data.id,
    method: 'PATCH',
    headers: {
...
var createNewFood = function createNewFood(data) {
  return $.ajax({
...
var getUserFoods = function getUserFoods() {
  return $.ajax({
    url: config.apiUrl + '/foods',
    method: 'GET',
    headers: {
...
var getOneFood = function getOneFood(data) {
  return $.ajax({
...
var deleteOneFood = function deleteOneFood(data) {
  return $.ajax({
    url: config.apiUrl + '/foods/' + data.id,
    method: 'DELETE',
    headers: {
...
var updateOneFood = function updateOneFood(data) {
  return $.ajax({
    url: config.apiUrl + '/foods/' + data.id,
    method: 'PATCH',
    headers: {
...
var myShelters = function myShelters(data) {
  return $.ajax({
...
module.exports = {
  ...
  getOnePet: getOnePet,
  deleteOnePet: deleteOnePet,
  updateOnePet: updateOnePet,
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://cat-snack.herokuapp.com/',
...
var onPwSuccess = function onPwSuccess() {
  $('.modal-body').html('');
  $("#myModalLabel").html('Success!');
...
var pwError = function pwError(error) {
  if (error) {
    $('.modal-body').html('');
    $("#myModalLabel").html('Error');
...
var onCreatePetSuccess = function onCreatePetSuccess(data) {
  store.pet = data.pet;
  $('.modal-body').html('');
...
var onCreatePetError = function onCreatePetError(error) {
  if (error) {
    $('.modal-body').html('');
    $("#myModalLabel").html('Error');
...
var onGetPetSuccess = function onGetPetSuccess(data) {
  $('.modal-body').html('');
...
var getPetError = function getPetError(error) {
  if (error) {
    $('.modal-body').html('');
    $("#myModalLabel").html('Error');
...
var onGetOnePetSuccess = function onGetOnePetSuccess(data) {
  $('.modal-body').html('');
...
var getOnePetError = function getOnePetError(error) {
  if (error) {
    $('.modal-body').html('');
    $("#myModalLabel").html('Error');
...
var onDeletePetSuccess = function onDeletePetSuccess(data) {
  $('.modal-body').html('');
...
var deletePetError = function deletePetError(error) {
  if (error) {
    $('.modal-body').html('');
    $("#myModalLabel").html('Error');
...
var onCreateFoodSuccess = function onCreateFoodSuccess(data) {
...
var createFoodError = function createFoodError(error) {
  if (error) {
    $('.modal-body').html('');
    $("#myModalLabel").html('Error');
...
var onGetFoodsSuccess = function onGetFoodsSuccess(data) {
  $('.modal-body').html('');
...
var getFoodsError = function getFoodsError(error) {
  if (error) {
    $('.modal-body').html('');
    $("#myModalLabel").html('Error');
...
var onGetOneFoodSuccess = function onGetOneFoodSuccess(data) {
  $('.modal-body').html('');
...
var getOneFoodError = function getOneFoodError(error) {
  if (error) {
    $('.modal-body').html('');
    $("#myModalLabel").html('Error');
...
var onDeleteFoodSuccess = function onDeleteFoodSuccess(data) {
  $('.modal-body').html('');
...
var deleteFoodError = function deleteFoodError(error) {
  if (error) {
    $('.modal-body').html('');
    $("#myModalLabel").html('Error');
...
var onUpdateFoodSuccess = function onUpdateFoodSuccess(data) {
  store.food = data.food;
  $('.modal-body').html('');
...
var updateFoodError = function updateFoodError(error) {
  if (error) {
    $('.modal-body').html('');
    $("#myModalLabel").html('Error');
...
var onShelterSuccess = function onShelterSuccess(data) {
...
module.exports = {
  ...
  onPwSuccess: onPwSuccess,
  pwError: pwError,
  onLogoutSuccess: onLogoutSuccess,
  logoutError: logoutError,
  loginError: loginError,
  registerError: registerError,
  onCreatePetSuccess: onCreatePetSuccess,
  getPetError: getPetError,
  onGetPetSuccess: onGetPetSuccess,
  onGetOnePetSuccess: onGetOnePetSuccess,
  getOnePetError: getOnePetError,
  onDeletePetSuccess: onDeletePetSuccess,
  deletePetError: deletePetError,
  onUpdateSuccess: onUpdateSuccess,
  updateError: updateError,
  onCreateFoodSuccess: onCreateFoodSuccess,
  createFoodError: createFoodError,
  onGetFoodsSuccess: onGetFoodsSuccess,
  getFoodsError: getFoodsError,
  onGetOneFoodSuccess: onGetOneFoodSuccess,
  getOneFoodError: getOneFoodError,
  onDeleteFoodSuccess: onDeleteFoodSuccess,
  deleteFoodError: deleteFoodError,
  onUpdateFoodSuccess: onUpdateFoodSuccess,
  updateFoodError: updateFoodError,
  onShelterSuccess: onShelterSuccess
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
